  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-emerald-50 flex items-center justify-center p-4">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-80 h-80 bg-violet-100 rounded-full mix-blend-multiply filter blur-3xl opacity-30 animate-blob animation-delay-4000"></div>
      </div>

      {/* Card */}
      <div className="relative w-full max-w-md">
        {/* Glass Effect Card */}
        <div className="backdrop-blur-xl bg-white/80 rounded-2xl shadow-2xl shadow-emerald-500/10 border border-white/20 p-8">
          {/* Header */}
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <div className="relative group">
                <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none transition-colors duration-300">
                  <Mail className={`w-5 h-5 ${focusedField === "email" ? "text-emerald-500" : "text-slate-400 group-hover:text-emerald-400"}`} strokeWidth={2} />
                </div>
                ...
                <input
                  ...
                  className="w-full pl-12 pr-4 py-3.5 bg-white/60 border-2 border-slate-200 rounded-xl text-slate-700 placeholder-slate-400 focus:outline-none focus:border-emerald-400 focus:ring-4 focus:ring-emerald-100 transition-all duration-300 hover:border-slate-300"
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center">
                ...
                <span className="text-sm text-slate-500 font-medium">Use your registered password</span>
              </div>
              <div className="relative group">
                <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none transition-colors duration-300">
                  <Lock className={`w-5 h-5 ${focusedField === "password" ? "text-emerald-500" : "text-slate-400 group-hover:text-emerald-400"}`} strokeWidth={2} />
                </div>
                ...
                <input
                  ...
                  onBlur={() => setFocusedField(null)}
                  className="w-full pl-12 pr-12 py-3.5 bg-white/60 border-2 border-slate-200 rounded-xl text-slate-700 placeholder-slate-400 focus:outline-none focus:border-emerald-400 focus:ring-4 focus:ring-emerald-100 transition-all duration-300 hover:border-slate-300"
                  placeholder="••••••••"
                />
          ...
          <div className="grid grid-cols-2 gap-4">
            <button className="flex items-center justify-center gap-3 py-3 px-4 bg-white border-2 border-slate-200 hover:border-slate-300 rounded-xl text-slate-700 font-medium hover:bg-slate-50 transition-all duration-300 group">
